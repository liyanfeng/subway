...
<body>
	<div id="myform" class="form">
		...
		<table>
			...
			<tr>
				<td>故障设备</td>
				<td colspan="3"><input id="device" name="device" class="mini-textbox" required="true" emptyText="请输入故障设备" style="width:150px;"onenter="onKeyEnter" /></td>
				<td>故障原因</td>
	...
	<script type="text/javascript">
			...
			function commit(){
				...
				if(window.confirm("确定提交？")){
					...
					$.ajax({
					    url: "/ssh/FaultAction!CauseAnalyse",
					    type: "post",
					    data: { data: json },
		...
		function setDisabled() {
			...
			mini.get("#device").setEnabled(true);
			mini.get("#cause").setEnabled(true);
			mini.get("#causeAnalyse").setEnabled(true);
		}
