...
-->
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="/ssh/FaultAction!findFaultBySearchVOforGongban" idField="id"
		allowResize="true">
...
<script type="text/javascript">
		...
		function edit() {
			...
			if (row) {
				...
				if(row.isConfirm=="已确定")
				var urlstring="/ssh/gongban/AnalyzeCause.jsp?code="+row.code;
				else
				var urlstring="/ssh/gongban/EditProcess.jsp?code="+row.code;
				mini.open({
					url : urlstring,
					title : "查看故障信息",
					width : 1000,
